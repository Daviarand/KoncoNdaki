...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan - KoncoNdaki</title>
    ...
    <section class="error-section">
        <div class="error-container">
            ...
            <p class="error-message">
                Oops! Sepertinya Anda tersesat di jalur pendakian yang salah. 
            ...
            <div class="error-actions">
                ...
                <a href="info-gunung.php" class="btn-error btn-secondary">
                    <i class="fas fa-mountain"></i>
                    Jelajahi Gunung
                </a>
            </div>
